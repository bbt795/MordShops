package me.billbominecraft.mordshops.utils;
...
public class ShopUtils {
    ...
    public static void storeItems(List<ItemStack> items, Player p){
        ...
        if (items.size() == 0){
            data.set(new NamespacedKey(MordShops.getPlugin(), "shop"), PersistentDataType.STRING, "");
        }else{
            ...
            try{
                ...
                data.set(new NamespacedKey(MordShops.getPlugin(), "shop"), PersistentDataType.STRING, encodedData);
    ...
    public static ArrayList<ItemStack> getItems(Player p){
        ...
        String encodedItems = data.get(new NamespacedKey(MordShops.getPlugin(), "shop"), PersistentDataType.STRING);
